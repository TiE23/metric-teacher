...
const DocumentationPage = props => (
  <div id="top">
    ...
    <Container>
      <Link to="/docs/test" replace>Test</Link>
      <br />
      <Link to="/docs/dog/hands" replace>Dog Hands</Link>
      <br />
      <Link to="/docs/fail" replace>Fail</Link>
      <br />
      <Link to="/docs/fail/fail" replace>Fail Fail</Link>
      <br />
      ...
      <span id="dog-hands">Dog Hands</span>
      ...
      <br />
      <Link to="/docs/top" replace>To Top</Link>
    </Container>
  </div>
);
