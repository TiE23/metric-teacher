...
export const PaulE = (
  <p>
    {SITE_NAME}'s mascot, <i>{MASCOT_NAME_LONG}</i>, and other digital art is by <b>Paul E</b>. His art and information on commissions can be found on <XLink to="http://paulstation2.tumblr.com/tagged/art">Tumblr</XLink>. <i>Please take note that some of his art, while always tasteful, sometimes contain mild nudity.</i>
  </p>
);
