    ...
    <Grid.Row>
      <Grid.Column>
        <Container text>
          ...
          <p>
            {SITE_NAME} is a personal project of Seattle-based web developer <b>Kyle Geib</b> with digital art created by <b>Paul E</b>.
          </p>
          <p>
            Learn more about us <Link to="/credits">here</Link>.
          </p>
        </Container>
      </Grid.Column>
    </Grid.Row>
